...
@objc(TRWeatherUpdate) class WeatherUpdate: NSObject, NSCoding {
    let date: NSDate
    ...
    init?(placemark: CLPlacemark, currentConditionsJSON: [String: AnyObject], yesterdaysConditionsJSON: [String: AnyObject], date: NSDate) {
        self.date = date
    ...
    convenience init?(placemark: CLPlacemark, currentConditionsJSON: [String: AnyObject], yesterdaysConditionsJSON: [String: AnyObject]) {
